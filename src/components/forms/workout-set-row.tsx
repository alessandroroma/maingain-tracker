...
export function WorkoutSetRow({ setNumber, weight, reps, rpe, rir, onWeightChange, onRepsChange, onRpeChange, onRirChange }: WorkoutSetRowProps) {
  return (
    <div className="grid grid-cols-6 gap-2 items-end">
      ...
      <div className="pt-4 text-muted">—</div>
    </div>
  );
}
